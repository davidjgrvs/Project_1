...
public class UserInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<ul>");
		out.println("<li>First Name: " + clientUser.getU_firstname() + "</li>");
		out.println("<li>Last Name: " + clientUser.getU_lastname() + "</li>");
		out.println("<li>Email: " + clientUser.getU_email() + "</li>");
		out.println("<li>Role: " + role.getUr_role() + "</li>");
		out.println("</ul>");
		...
		out.println("<br/><br/><button id=\"updateInfoButton\">Update</button>");
