...
public class ChangeUserInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				out.println("<br/><br/><form method=\"POST\" action=\"changeInfo\"><br/>");
				out.println("<input type=\"text\" value=\"" + clientUser.getU_firstname() + "\" name = \"firstname\"><br/>");
				out.println("<input type=\"text\" value=\"" + clientUser.getU_lastname() + "\" name = \"lastname\"><br/>");
				out.println("<input type=\"text\" value=\"" + clientUser.getU_email() + "\" name = \"email\"><br/>");
				out.println("<input type=\"submit\" value=\"Update\"></input></form><br/>");
